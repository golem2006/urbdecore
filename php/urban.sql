...
--
-- Хост: MySQL-8.4:3306
-- Время создания: Апр 26 2026 г., 18:34
...
(4, 'Современная книжная полка', 'Мебель', 3, 17910.00, 15210.00, 1, 0, 8, 'img/modern-bookshelf.jpg'),
...
(8, 'Льняные шторы', 'Текстиль', 4, 11610.00, 10440.00, 1, 0, 22, 'img/linen-curtains.jpg'),
(9, 'Супер шторы', 'Текстиль', 5, 13500.00, 12750.00, 1, 0, 28, 'img/super-curtains.jpg');
